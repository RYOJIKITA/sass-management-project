class ArifactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @arifact.save
        format.html { redirect_to @arifact, notice: 'Arifact was successfully created.' }
  ...
  def destroy
    @arifact.destroy
    respond_to do |format|
      format.html { redirect_to arifacts_url, notice: 'Arifact was successfully destroyed.' }
  ...
  private
    ...
    def arifact_params
      params.require(:arifact).permit(:name, :key, :project_id)
    end
end
